...
getFanWorkTypes = () => {
    return [
        ...
        { typeString: "Animation", icon: ":cinema:", colapseMultiple: "animations", statDescriptionString: "Animation", isGalleryType: true },
        ...
        { typeString: "Music", icon: "<:harp:851693676711378946>", colapseMultiple: "pieces", statDescriptionString: "Song", isGalleryType: false },
        { typeString: "Food", icon: ":fork_and_knife:", colapseMultiple: "foods", statDescriptionString: "Food", isGalleryType: true },
