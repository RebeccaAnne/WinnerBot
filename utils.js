...
getFanWorkTypes = () => {
    return [
        ...
        { typeString: "Sticker", icon: ":frame_photo:", colapseMultiple: "stickers", statDescriptionString: "Sticker", isVisualArt: false },
        { typeString: "Calligraphy", icon: ":pen_fountain:", colapseMultiple: "pieces", statDescriptionString: "Calligraphy Piece", isVisualArt: true },
        { typeString: "Data and Charts", icon: ":chart_with_upwards_trend:", colapseMultiple: "data analyses", statDescriptionString: "Data Analysis", statDescriptionStringCustomPlural: "Data Analyses", isVisualArt: false },
        { typeString: "Music", icon: "<:harp:851693676711378946>", colapseMultiple: "pieces", statDescriptionString: "Song", isVisualArt: false },
        { typeString: "Food", icon: ":fork_and_knife:", colapseMultiple: "foods", statDescriptionString: "Food", isVisualArt: true },
        ...
        { typeString: "Podfic", icon: ":sound:", colapseMultiple: "podfics", statDescriptionString: "Podfic", isVisualArt: false }
    ]
}
